...
extern unsigned char  Write_MDB_Command(unsigned char  slaveNo, unsigned char  functionCode, short int startAddress, short int  numItems, unsigned char  *dataBuffer, unsigned char  numRetries);
extern unsigned char  Read_MDB_Response(unsigned char  slaveNo, unsigned char  functionCode, short int startAddress, short int  numItems, unsigned char  *dataBuffer, unsigned char  numRetries);
...
extern unsigned char  DecodeResponse(MDB_REQ_ADU *pMbReqAdu, MDB_RSP_ADU *pMbRspAdu, unsigned char  *dataBuffer, short int numItems);
extern unsigned char  CheckCrc(MDB_RSP_ADU *pMbRspAdu);
...
unsigned char ReadPort(short int noOfBytesToRead,unsigned char  *pDstBuffer);
